...
void Cryptogram::runTestCases(PatternDictionary& dictionary)
{
    std::vector<std::string> testStrings = {
        ...
        "KTVE OQSY ASG T CTGXQVZ SA GQTESHE XHKDJLXHN T GQPJQEV ASG TVVQHVXSH, T KTDD SA FTXH, WJHNQG, SG QCQH TE T NGQQVXHN. ESOQ KTVE TGQ CQGZ CSKTD YWXDQ SVWQGE TGQ CQGZ PJXQV. KTVE KTH OTUQ JF VS SHQ WJHLGQL CSKTD ESJHLE.",
        "GODI DFCZGOQQF CYJJ SMNX DMNF OJN MOCCF RJ GRXDNXD. IRANDZANI O GOD AOF OQIR CYJJ SMNX ZD ZI MYJD RJ BNNQI VZIDJNII. ZD ZI DMRYEMD DMOD DMN IRYXV GRANI BJRA JMFDMAZG ZACYQINI DR DMN GOD'I QOJFXU.",
        "FMOZ MTJ PJTV FGJMY FTJMOQTJZ OKMO FGJMY OKJEZJGPJZ HV GLFBLYX OKJLT UQT. FMOZ MGZI JYRIV XTIIELYX IOKJT FMOZ MYW KQEMYZ. ZIEJOLEJZ KMLTHMGGZ WJPJGIS UTIE MGG OKJ XTIIELYX."
    };
